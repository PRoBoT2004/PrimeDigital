...
const ServiceCard = ({ service, onOpenModal }) => {
  ...
  return (
    ...
    >
      {/* Service Card */}
      <div className="relative h-full p-8 transition-all duration-500 border bg-gradient-to-br from-gray-900/50 to-gray-800/30 rounded-2xl backdrop-blur-xl border-gray-700/50 group-hover:border-blue-500/50 group-hover:shadow-2xl group-hover:shadow-blue-500/10 group-hover:-translate-y-2">
        ...
        <div className="relative z-10">
          ...
          <button 
            ...
            className="relative px-6 py-3 overflow-hidden font-medium text-white transition-all duration-300 rounded-lg group/btn bg-gradient-to-r from-gray-800 to-gray-700 hover:from-blue-600 hover:to-blue-700 hover:shadow-lg hover:shadow-blue-500/25"
          >
